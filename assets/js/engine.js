(() => {
  ...
  function normalizeSlideLayout(slide) {
    ...
    // vertical space before the browser does real measurement later.
    ...
    // coordinate system as the layout anchors.
    ...
    // which would either clip the text or leave too little room below.
    ...
    // estimated headline height plus a fixed readability gap.
    ...
    return {
      ...
      positions: {
        ...
        // push them beyond the safe reading area.
